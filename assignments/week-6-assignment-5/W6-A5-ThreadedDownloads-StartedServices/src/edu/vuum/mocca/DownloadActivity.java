...
public class DownloadActivity extends DownloadBase {
    ...
    static class MessengerHandler extends Handler {
    	...
    	public void handleMessage(Message msg) {
    		...
    		if (activity != null) {
	            ...
	            // "PATHNAME".
    			//displayBitmap(msg.getData().getString("PATHNAME"));
                }
    	}
    }
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
        	...
        	Intent mIntentService = DownloadIntentService.makeIntent(this,
        			handler,
        			getUrlString());
        ...
        case R.id.thread_pool_button:
        	...
        	Intent mIntentThread = ThreadPoolDownloadService.makeIntent(this,
        			handler, 
        			getUrlString());
